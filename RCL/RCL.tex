...
\begin{center}
\includegraphics[scale=0.7]{formatosegmentotcp.png}
\end{center}
% https://elearning.di.unipi.it/pluginfile.php/28129/mod_resource/content/1/L07_Trasporto_TCP_intro.pdf, 27
\end{document}