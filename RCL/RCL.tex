...
\pagebreak
\section{NAT}
Il \textbf{Network Address Translation} (\texttt{RFC 2663}, \texttt{RFC 3022}) permette di \textbf{trasmettere su internet il traffico proveniente da sistemai attestati su sottoreti private}, in cui sono assegnati indirizzi IP privati.\\
