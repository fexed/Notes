...
\textbf{Non c'è un servizio di directory centralizzato}, i peer \textbf{si organizzano in una overlay network} (\textbf{rete logica}). Ci sono due categorie.
\subsubsection{Reti Strutturate}
