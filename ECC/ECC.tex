...
\paragraph{MdT a $k$ nastri} MdT come tutte le altre (Q, $\Sigma$, $\delta$, q$_0$) ma la $\delta$ è un po' diversa e $h$ stato di terminazione diviso in 2: stato si e stato no.
\end{document}