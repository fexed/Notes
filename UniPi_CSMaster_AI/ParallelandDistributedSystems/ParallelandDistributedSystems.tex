...
\end{center}
MDF can issue some problems. First, the concurrency over the repository of course. Another problem is the result tokens delivery: each graph can need input tokens coming from different computations, and such we need to handle it. Another thing is maintaining the list of fireable instructions
