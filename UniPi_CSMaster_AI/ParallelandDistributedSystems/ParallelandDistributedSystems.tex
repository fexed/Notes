...
\begin{list}{}{}
	...
	\item \textbf{Availability}: every request receives a response, without the guarantee of containing the most recent write
	\item \textbf{Partition tolerance}: the system continues to operate despite an arbitrary number of messages being dropped or delayed
\end{list}
