...
$$L(x) = $$ %TODO
Reconstruction phase: update encoder and decoder to minimize reconstruction error\\
...
Adversarial regularization allows to impos prioprs for which we cannote compute the KL divergence.\\
