...
Even if $S_t^e$ is visible %TODO
\paragraph{Agent State} The agent state $S_t^a$ is the internal representation owned by agent $a$. Generally speaking is a function of history.
...
The state is a sufficient statistics for the future. %TODO
\paragraph{Observability}
\begin{list}{}{}
	\item \textbf{Partially Observable Environment} %TODO
\end{list}
\paragraph{Key Components of a Reinforcement Learning Agent} A RL agent may include one or more of these:
\begin{list}{}{}
