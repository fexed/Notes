...
\end{list}
\subsection{Graphical Models Framework}
...
\subsubsection{Representation} A graph whose nodes are random variables and edges represent probabilistic relationships between the variables.\\
...
\texttt{todo} %TODO
\subsection{Inference} Bayesian: consider all hypothesis weighted by their probabilities
