...
\begin{tikzpicture}[node distance={25mm}, main/.style = {draw, circle}] 
\node[main] (1) {Animal}; 
\node[main] (2) [below of=1] {Mammal};
\node[main] (3) [right of=2] {4};
\node[main] (4) [below of=2] {Elephant};
\node[main] (5) [right of=4] {grey};
\node[main] (6) [below of=4] {Clyde};
\draw[->] (6) -- (4) node [pos=0.5, left] {INST-OF};
\draw[->] (4) -- (2) node [pos=0.5, left] {IS-A};
\draw[->] (2) -- (1) node [pos=0.5, left] {IS-A};
\draw[->] (2) -- (3) node [pos=0.5, above] {NLegs};
\draw[->] (4) -- (5) node [pos=0.5, above] {Color};
\end{tikzpicture}
\end{center}
