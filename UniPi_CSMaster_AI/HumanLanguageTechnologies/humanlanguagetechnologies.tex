...
\paragraph{Coreference Evaluation} %TODO p.65 23-coref.pdf 2/5/22
...
Knowledge-aware LMs are important. LM pretrained representations can benefit downstream tasks that leverage knowledge. For instance, question answering and information extraction are easier with some knowledge of the entities involved. Stretch goal: can LMs ultimately replace traditional knowledgebases? Instead of querying a knowledge base %TODO
...
\subparagraph{WKLM} %TODO
\subparagraph{Inductive Biases Through Masking} Cam we encourage LM %TODO
