...
\end{list}
\paragraph{Definizione} Il \textbf{version space} $VS_{H, D}$, rispetto allo spazio delle ipotesi $H$ e al training set $D$, è il \textbf{sottoinsieme delle ipotesi di $H$ consistenti con tutti gli esempi d'apprendimento}
\begin{list}{}{}
