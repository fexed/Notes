...
Soluzione: consentire errori introducendo le slack-variables.
\paragraph{Forma Primale soft margin} Minimizzare $\mathlarger{\frac{|\text{w}|^2}{2} + C\cdot\sum_i \xi_i}$ (cioè w$^T$w) in maniera che $($wx$_i + b)y_i \geq 1\:\:\forall\:i$\\
\end{document}
