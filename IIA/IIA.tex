...
\begin{list}{}{Definizioni}
	\item \textbf{General boundary} G di $VS_{H,D}$, è l'insieme dei membri (di $H$ consistenti con $D$) \textbf{massimamente generici}
	\item \textbf{Specific boundary} S di $VS_{H,D}$, è l'insieme dei membri (di $H$ consistenti con $D$) \textbf{massimamente specifici}
...
%TODO IIA-20-ML-concept-learning-v0.1.pdf, p. 26
