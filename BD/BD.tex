...
\lstset{
	...
	morekeywords={database, REFERENCES, SCHEMA, AUTHORIZATION, PROCEDURE, WITH, CHECK, OPTION},
}
...
\chapter{Vincoli}
% https://elearning.di.unipi.it/pluginfile.php/31092/mod_resource/content/2/7.SQLDefinizioneDati.pdf, p. 57
\end{document}