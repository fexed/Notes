...
\paragraph{L'algoritmo di analisi} R$\langle$T,F$\rangle$ è decomposta in R$_1$(X, Y) e R$_2$(X, Z) e su di esse si repete il procedimento, esponenziale.
...
\end{enumerate}
%TODO https://elearning.di.unipi.it/pluginfile.php/31312/mod_resource/content/2/9.RealizzazioneDBMS_Parte_I.pdf
\end{document}