...
A planning graph is a directed graph which is \textbf{built forward} and is \textbf{organized into levels}:\begin{list}{}{}
	\item A levels $S_0$ for the initial state, representing each fluent that holds in $S_0$
...
\begin{list}{}{}
	...
	\item The level $j$ at with a literal first appears is never grater than the level at which it can be achieved. We cal this the \textbf{level cost} of a literal/goal
