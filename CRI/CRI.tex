...
\subsection{Generatore di sequenze brevi}
...
\begin{list}{}{}
	...
	\item Output: flusso di dati %TODO
	\item \# Sequenze diverse: $2^s << 2^n$ \# sequenze possibili
\end{list}
...
\paragraph{Generatore polinomiale} Non è crittograficamente sicuro. %TODO
