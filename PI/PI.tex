...
Ci sono metodi per arrivare alla disruptive innovation, non si sogna come doc. Cos'è: innovazione non lineare. Linare è migliorare sistema esistente: abbasso consumi, miglioro efficienza.\\La disruptive è un salto di binario. Prima si guardavano i film andando fisicamente a prenderli a noleggio adesso si apre internet e Netflix.\\Cambia il modello e soprattutto cambia il modello di business.\\
Ciò che nasce da processo disruptive, tipicamente falliscono i metodi di business classici.\\
Cliente del nuovo modello di sistema e business non è tipicamente conosciuto, nemmeno il mercato: impossibile user experience analysis.\\\\
\textbf{root cause analysis} analisi origine delle cause. La gente non vuole uno scaffale ma un modo per contenere i libri: kindle.\\Si pensa a cosa fa e perché fa chi legge un libro, non a migliorare il libro. Il libro è contenitore di testo $\rightarrow$ kindle.\\\\
Per disruptive innovation si spacchetta: RCA, root cause analysis.\\
Spotify, Netflix, Uber, Amazon hanno fatto questo.\\\\
\subsection{Why root cause analysis}
Processo RCA più tipico. non ci si ferma a dire cosa è successo, si vanno a comprendere le cause alla base del perché è capitato.\\
\begin{enumerate}
\item identificare e descrivere chiaramente il problema. Spostare persone da punto a a punto b
\item Creare una timeline che porti sequenzialemnte da identificazione bisogno a compimento e soluzione del bisogno.\\Chiamo taxi, aspetto, si ferma, entro, dico dest.\ldots
\item Distinguere le vere cause (root cause) dai fattori laterali. Non c'entra la dimensione della pensilina d'attesa, è un problema locale.
\item Creare grafico di relaioni tra problema e root cause
\end{enumerate}
Perché serve perché avere struttura così solida aiuta a discutere in azienda, team ecc\ldots su come innovare. Si discute su forma e metodo ma non su come andare da punto a a punto b. Quel modo unico va scritto. La task analysis (o root cause analysis, essa produce serie di task quindi task analysis è prodotto dalla rca).\\Task estratti sono tipo utente non tecnologico, si parla della user experience. Task analysis è processo di apprendiemtno di un fenomeno fatto tramite l'esperienza. \textbf{estrarre più task più dettagliati possibile} al fine di
\begin{list}{}{}
\item comprendere nel profondo i goal
\item cosa fanno gli utenti per raggiungere quell'obiettivo
\item quale esperienza (personale, sociale, culturale) l'utente porta all'attività
\item come gli utenti sono influenzati dall'ambiente circostante
\item quale era la conoscenza precedente che influenzava l'esperienza
\end{list}
due metodi per due tip di task analysis
\begin{list}{}{}
\item cognitive task analysis: focus sul capire task che richiedono decisio-making, problem-solving, memoria, attenzione, giudizio
\item hierarchical task analysis: butto giù task macrolivello e scompongo in sottotask
\end{list}
Livello di dettaglio: quando mi fermo? è un'arte, non c'è un metodo o una formula. Richiede esperienza e buonsenso. Bene definire criterio di stopping, anche se all'inizio non si hanno gli strumenti per farlo. All'inizio, meglio più dettagliata possibile, poiché no esperienza sull'eliminare.\\\\\\
Ora vogliamo innovare e creare qualcosa di nuovo
\section{AGILE}
Si pensa che agile sia strumento e scrum/extreme programming strumenti. In verità agile è modo di pensare come design thinking, fa parte della famiglia dei metodi di lavoro.\\
design thinking è come ci poniamo nella soluzione dei problemi\\
agile è come applichiamo i metodi del design thinking allo sviluppo software.\\
\textbf{AGILE è forma mentis}, poi lo scrum è tecnica di organizzazione team di tipo agile.\\\\
Focus è su individui e interazione (programmatori) invece che dei processi e tool (di sviluppo)\\
Software funzionante invece di grandi documenti\\
Capacità di adattamento al cambiamento.
\subsection{12 principi dell'agile}
il grande concetto è quello della \textbf{adattabilità}. mancanza struttura e documenti non è anarchia, ma anzi è molto complesso senza grande capo e dover rendere conto ad ogni membro di aver fatto qualcosa che garantisca a lui libertà di fare altro.\\
\section{Personas}
